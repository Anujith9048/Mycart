  ...
  <html lang="en">
     ...
     <body class="" >
        ...
        <div class="d-flex justify-content-center align-items-center log-content">
           <form class="col-lg-4 col-md-6 col-sm-8 col-11 p-3 pt-0 px-0 rounded-3">
              ...
              <div class="form-contents px-3 pb-3 pt-4">
                 ...
                 <button class="btn btn-outline btn-outline1 w-100 button-abt " id="submitLogin">Submit</button>
              </div>
           </form>
        </div>
        <script src="../assets/script/jquery.js"></script>
