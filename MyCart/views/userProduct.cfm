  ...
  <html lang="en">
     <head>
        ...
        <title>MyCart | <cfoutput>#local.product.FLDPRODUCTNAME#</cfoutput></title>
     ...
     <body>
       ...
       <div id="carouselExampleIndicators" class="carousel carousel-dark slide col-5" data-bs-ride="carousel">
        ...
        <cfoutput>
                     ...
                     <cfif session.isLog>
                        ...
                        <cfelse>
                           <div class="alert alert-danger" role="alert">
                             You are not logged in. Please loggin!!
                            </div>
                            
                           <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                              <a href="##" class="btn btn-success" id="loginOnBuy"  proid="#url.proid#" mode="buy">Loggin</a>
                           </div>
                     </cfif>
                  </div>
              </div>
         ...
         <!-- Login Modal -->
         <div class="modal fade" id="logModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog d-flex gap-0">
               <div class="modal-content border-0 rounded-0 rounded-start">
                  <div class="modal-header create-bg">
                     <h5 class="modal-title color-address create-title w-100 text-center py-2 rounded-pill" id="exampleModalLabel">Loggin</h5>
                  </div>
                  <div class="modal-body">
                     <form action="homePage.cfm" method="post" enctype="multipart/form-data">
                        <table class="table">
                           <tbody>
                              <tr id="categories">
                                 <td>
                                    <label for="" class="form-text fw-bold color-address">User Name*</label>
                                    <input type="text" class="form-control" placeholder="User Name" id="InputUname">
                                    <p id="errorUname" class="text-danger"></p>
                                 </td>
                              </tr>
                              <tr id="categories">
                                 <td>
                              ...
                              <tr id="categories">
                                 <td>
                                    <label for="" class="form-text fw-bold color-address">Password*</label>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" id="loginModal" class="btn btn-primary" data-id="#url.proid#" data-type="cart">Login</button>
                  </div>
               </div>
            </div>
         </div>
